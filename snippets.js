export const SNIPPETS_DICT = {
    ...
    guess: `<odeComponent>
          ...
          <htmlView><![CDATA[<div class="adivina-IDevice"><div class="adivina-instructions gameQP-instructions"><p>Adivina las palabras.</p></div><div id="adivina-DataGame-UUID-IDEVICE" class="adivina-DataGame" data-id="UUID-IDEVICE"></div><script type="text/javascript">$exe.adivina.init("UUID-IDEVICE")</script></div>]]></htmlView>
